...
const Projects = () => {
  return (
    <div>
        ...
        <div className="px-4 py-5 md:flex md:justify-around">
                <div className="border-2 rounded-[20px] border-solid border-[#d9d9d9] w-[400px] md:h-[300px] px-5">
                ...
                <div className="border-2 rounded-[20px] border-solid border-[#d9d9d9] w-[400px] md:h-[300px] px-5 mb-4">
